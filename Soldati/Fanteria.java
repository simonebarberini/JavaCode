public class Fanteria extends Soldato implements Specialista {
    ...
    public Fanteria(String nome, String cognome, String grado, String equipaggiamentoSpeciale, String specializzazione){
        this.nome = nome;
    ...
    public String toString() {
        return "Sono " + this.nome + " " + this.cognome + " un " + this.grado + " di fanteria.";
    }
}
